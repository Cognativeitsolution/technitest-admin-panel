...
import type { UserReview } from "@/data/feedback";
...
type UserReviewsTableProps = {
  ...
  onMessageClick: (review: UserReview) => void;
};
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[750px] border-collapse text-left">
          ...
          <tbody>
            ...
            {reviews.length === 0 ? (
              <tr><td colSpan={7} className="px-5 py-10 text-center text-sm text-[#6b7280]">No user reviews found.</td></tr>
            ) : null}
          </tbody>
        </table>
      </div>
