...
import { FolderTree, Hammer, Pencil, RotateCcw, Trash2 } from "lucide-react";

import { Can } from "@/components/shared/can";
import { cn } from "@/lib/utils";
import type { TradeItem } from "@/types/trade.types";

const TRADE_WRITE_PERMISSIONS = ["trade:create", "category:create"];
const TRADE_UPDATE_PERMISSIONS = ["trade:update", "category:update"];
const TRADE_DELETE_PERMISSIONS = ["trade:delete", "category:delete"];
const TRADE_RESTORE_PERMISSIONS = ["trade:restore", "category:restore"];
